...
type id =
  ...
  | RacerDFixIssues  (** directory of issues reported by the RacerD analysis *)
  ...
  | ReportFixJson  (** the main product of the analysis&fix: [report_fix.json] *)
  | SummariesJson  (** the main product of the racerdfix analysis: [summaries_racerd.json] *)
